...
import 'package:instagram_clone_flutter/model/exercise_set.dart';
import 'package:instagram_clone_flutter/widgets/video_controls_widget.dart';
  ...
  Widget buildVideoControls() =>
      VideoControlsWidget(
        ...
        onTogglePlaying: (isPlaying) {
          setState(() {
            final controller = currentExercise.controller;
            if (controller != null) {
              if (isPlaying) {
                controller.play();
              } else {
